...
logging.info(f"train_feature_slice.shape: {train_feature_slice.shape}")
logging.info(f"train_label_slice.shape: {train_label_slice.shape}")
...
logging.info(f"test_feature_slice.shape: {test_feature_slice.shape}")
logging.info(f"test_label_slice.shape: {test_label_slice.shape}")
